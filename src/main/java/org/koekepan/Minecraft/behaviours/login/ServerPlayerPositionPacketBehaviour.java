...
public class ServerPlayerPositionPacketBehaviour implements Behaviour<Packet> {
	...
	public void process(Packet packet) {
		...
		Logger.log(this, Logger.Level.DEBUG, new String[]{"network", "behaviour", "entityMovement"} ,"Player \""+proxySession.getUsername()+"\" received location: "+p.toString());
		...
		proxySession.sendPacketToVastMatcher(responsePacket);
