package org.koekepan.behaviours.login;
...
public class MigrateLoginSuccessPacketBehaviour implements Behaviour<Packet> {
	...
	public void process(Packet packet) {
		...
		Logger.log(this, Logger.Level.DEBUG, new String[]{"network", "behaviour", "migration"} ,"Player \""+loginSuccessPacket.getProfile().getName()+"\" has successfully logged into the server");
