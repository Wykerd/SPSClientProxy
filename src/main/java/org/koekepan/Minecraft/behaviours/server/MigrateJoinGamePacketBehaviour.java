...
//		Logger.log(this, Logger.Level.INFO, new String[]{"network", "behaviour", "connection", "initialisation"} ,"Player \""+proxySession.getUsername()+"\" with entityID <"+serverJoinPacket.getEntityId()+"> has successfully joined world");
