...
public class ServerPluginMessagePacketBehaviour implements Behaviour<Packet> {
	...
	public void process(Packet packet) {
		...
		if (pluginMessagePacket.getChannel().equals("Koekepan|migrate")) {
			...
			Logger.log(this, Logger.Level.DEBUG, new String[]{"network", "behaviour", "migration"} ,"Received a migration message for client <"+proxySession.getUsername()+"> to migrate to server <"+hostname+">");
			...
			Logger.log(this, Logger.Level.DEBUG, new String[]{"network", "behaviour", "migration"} ,"Received a kick message for client <"+proxySession.getUsername()+"> with reason <"+reason+">");
